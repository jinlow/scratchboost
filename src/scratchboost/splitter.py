        ...
        for i in range(0, g.shape[0] - 1):
            ...
            if split_gain > max_gain:
                ...
                split_info = SplitInfo(
                    ...
                    split_value=cuts[i],
                    split_index=i + 1,
                    children_gain=[left_gain, right_gain],
                    children_cover=[left_hessian, right_hessian],
                    children_weight=[left_weight, right_weight],
                    children_bounds=[(-np.inf, cuts[i]), (cuts[i], np.inf)],
                )
        return split_info
